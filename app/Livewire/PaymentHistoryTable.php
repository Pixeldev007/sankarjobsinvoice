...
class TransactionTable extends LivewireTableComponent
{
    ...
    public $filterComponent = ['transactions.components.filter_and_export', Payment::PAYMENT_STATUS];
    ...
    public function columns(): array
    {
        return [
            ...
            Column::make(__('messages.invoice.payment_method'), 'payment_mode')
                ->searchable()
                ->view('transactions.components.payment-mode') // Make sure this view file exists and correctly displays the payment_mode
                ->filterable(), // Enable filtering for payment mode
