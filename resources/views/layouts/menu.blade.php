@role('admin')
    ...
    <li class="nav-item {{ Request::is('admin/payment-reports*') ? 'active' : '' }}">
        <a class="nav-link d-flex align-items-center py-3" aria-current="page" href="{{ route('payment-reports.index') }}">
            <span class="menu-icon">
                <i class="fa-solid fas fa-credit-card pe-3"></i>
            </span>
            <span class="aside-menu-title">{{ __('messages.payment_methods') }}</span>
        </a>
    </li>

    {{-- Payment Reports --}}
    <li class="nav-item {{ Request::is('payment-reports*') ? 'active' : '' }}">
        <a class="nav-link d-flex align-items-center py-3" aria-current="page" href="{{ route('payment.reports') }}">
            <span class="aside-menu-icon pe-3">
                <i class="fas fa-chart-pie"></i>
            </span>
            <span class="aside-menu-title">{{ __('messages.payment_reports') }}</span>
        </a>
    </li>
    ...
    <!--</li>-->
    <li class="nav-item">
        <a href="{{ route('invoice.reports') }}" class="nav-link">
            <span class="menu-icon">
                <i class="nav-icon fas fa-chart-bar pe-3"></i>
            </span>
            <span class="aside-menu-title">Invoice Reports</span>
        </a>
    </li>
    <li
