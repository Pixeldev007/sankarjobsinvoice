<div class="dropup position-static" wire:key="{{ $row->id }}">
    ...
    <a class="px-2" href="https://invoices.sankarjobs.com/invoice-pdf/<?= $row->invoice_id ?>" target="_blank">
    ...
    <ul class="dropdown-menu min-w-170px" aria-labelledby="dropdownMenuButton1">
        ...
        @endif
        <li>
            <a href="{{ route('invoices.img-edit', $row->id) }}" class="dropdown-item text-hover-primary me-1 edit-btn"
                data-bs-toggle="tooltip" title="{{ __('messages.common.edit') }}" data-turbo="false">
                <?php echo "Edit Image" ?>
            </a>
        </li>
