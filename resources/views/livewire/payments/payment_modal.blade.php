@php
    ...
    // Get an array of payment method names
    $paymentMethods = payment_method::pluck('payment_method')->toArray();
@endphp
            ...
            <div class="modal-body scroll-y">
                ...
                <div class="row">
                  ...
                  <div class="form-group col-lg-4 col-sm-12 mb-5">
                    ...
                    <div class="input-group">
                        {{ Form::select('payment_mode', array_combine($paymentMethods, $paymentMethods), old('payment_mode', null), [
                            'id' => 'adminPaymentMode',
                            'class' => 'form-control',
