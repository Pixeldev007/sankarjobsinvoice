...
<table class="table table-bordered border-primary">
    ...
    <tr>
        ...
        <th style="word-break: break-all;width: 15%"><b>Client Name</b></th>
        <th style="width: 15%"><b>Client Email</b></th>
        <th style="width: 10%"><b>Quote Date</b></th>
        <th style="width: 10%"><b>Amount</b></th>
        <th style="width: 10%"><b>Due Date</b></th>
        <th style="width: 10%"><b>Status</b></th>
        <th style="word-break: break-all;width: 10%"><b>Address</b></th>
    </tr>
    </thead>
    <tbody>
        @if(count($quotes) > 0)
