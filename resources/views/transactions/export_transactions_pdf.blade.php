    ...
    <table class="table table-bordered border-primary">
        <thead>
            <tr>
                ...
                @endif
                <th style="width: 10%;"><b>Payment Amount</b></th>
                <th style="width: 12%"><b>Payment Method</b></th>
            </tr>
        </thead>
        <tbody>
            @if (count($payments) > 0)
                @foreach ($payments as $payment)
                    <tr class="custom-font-size-pdf">
                        ...
                        <td class="right-align">
                            {{ getInvoiceCurrencyAmount($payment->amount, $payment->invoice->currency_id, true) }}
                        </td>
                        <td >
